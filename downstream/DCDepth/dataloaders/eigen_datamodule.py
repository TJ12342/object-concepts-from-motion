...
class EigenDataModule(LightningDataModule):
    def __init__(self, cfg):
        ...
        # prepare args
        args = {
            'filenames_file_eval': 'data_splits/eigen_test_files_with_gt.txt',  # files for online eval
            'filenames_file': 'data_splits/eigen_train_files_with_gt.txt',  # files for training
            'dataset': 'kitti',
            'use_right': False,
            'data_path': self.cfg.dataset.data_path,
            'data_path_eval': self.cfg.dataset.data_path,
            'gt_path': self.cfg.dataset.gt_path,
            'gt_path_eval': self.cfg.dataset.gt_path,
